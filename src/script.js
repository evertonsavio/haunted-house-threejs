...
grassAmbientOcclusionTexture.repeat.set(32, 32)
...
for (let i = 0; i < 250; i++) {
    ...
    grave.position.set(x, 0.8 * 0.3, z)
...
const tick = () => {
    ...
    ghost1.position.x = Math.cos(ghost1Angle) * (7 + Math.sin(elapsedTime * 2.5))
